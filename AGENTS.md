...
Caution: Once an explorer dies, the character cannot be restored. Monitor your HP via the `AdventurerHealth` model and exit the temple or rest if you are in danger.
