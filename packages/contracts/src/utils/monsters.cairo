...
pub fn get_monster_stats(monster_type: MonsterType) -> MonsterStats {
    match monster_type {
...
#[cfg(test)]
mod tests {
    use super::get_monster_stats;
    use d20::types::MonsterType;

    #[test]
    fn test_none_returns_zero_stats() {
        let stats = get_monster_stats(MonsterType::None);
    ...
    fn test_poisonous_snake_stats() {
        let stats = get_monster_stats(MonsterType::PoisonousSnake);
    ...
    fn test_skeleton_stats() {
        let stats = get_monster_stats(MonsterType::Skeleton);
    ...
    fn test_shadow_stats() {
        let stats = get_monster_stats(MonsterType::Shadow);
    ...
    fn test_animated_armor_stats() {
        let stats = get_monster_stats(MonsterType::AnimatedArmor);
    ...
    fn test_gargoyle_stats() {
        let stats = get_monster_stats(MonsterType::Gargoyle);
    ...
    #[test]
    fn test_mummy_stats() {
        let stats = get_monster_stats(MonsterType::Mummy);
    ...
    fn test_wraith_stats() {
        let stats = get_monster_stats(MonsterType::Wraith);
